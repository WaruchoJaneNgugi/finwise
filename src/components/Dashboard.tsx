...
const LEVEL_BG: Record<string, string> = {
  excellent: 'rgba(61,214,140,0.12)', good: 'rgba(96,165,250,0.12)',
  fair: 'rgba(251,191,36,0.12)', poor: 'rgba(251,146,60,0.12)', critical: 'rgba(248,113,113,0.12)',
};
      ...
      <div className="stats-grid">
        ...
        <div style={S.statCard}>
          ...
          <div style={S.progressBar}>
            <div style={{ ...S.progressFill, width: `${spendingPct}%`, background: spendingPct > 80 ? '#F87171' : '#60A5FA' }} />
          </div>
        ...
        <div style={S.statCard}>
          ...
          <div style={{ ...S.statValue, color: breakdown.unnecessaryTotal > 0 ? '#FBBF24' : '#3DD68C' }}>
            {formatCurrency(breakdown.unnecessaryTotal, profile.currency)}
          </div>
          <div style={S.progressBar}>
            <div style={{ ...S.progressFill, width: `${unnecessaryPct}%`, background: '#FBBF24' }} />
          </div>
        ...
        <div style={S.statCard}>
          ...
          <div style={{ ...S.statValue, color: breakdown.savingsLeft > 0 ? '#3DD68C' : '#F87171' }}>
                  ...
                  <div key={cat} style={S.categoryItem}>
                    <div style={S.catLeft}>
                      ...
                      <div>
                        ...
                        <div style={{ ...S.catType, color: meta?.type === 'unnecessary' ? '#FBBF24' : '#3DD68C' }}>{meta?.type}</div>
                      </div>
                    </div>
...
const S: Record<string, React.CSSProperties> = {
  ...
  scorePanelLabel: { fontSize: 12, color: '#9BAAC4', textTransform: 'uppercase', letterSpacing: '0.07em' },
  levelBadge: { fontSize: 10, fontWeight: 700, padding: '3px 8px', borderRadius: 4, letterSpacing: '0.08em' },
  scoreMessage: { fontSize: 13, color: '#9BAAC4', textAlign: 'center', lineHeight: 1.5 },
  categoriesCard: { background: '#132040', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 14, padding: '22px 24px' },
  cardTitle: { fontFamily: 'Cormorant Garamond, serif', fontSize: 18, fontWeight: 600, color: '#F0EDE4', marginBottom: 16 },
  emptyState: { color: '#5A6B8A', fontSize: 14, paddingTop: 8 },
  ...
  catName: { fontSize: 14, color: '#F0EDE4', fontWeight: 500, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
  ...
  warningBullet: { color: '#FBBF24', fontWeight: 700, flexShrink: 0 },
};
